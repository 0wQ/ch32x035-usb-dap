...
target("firmware")
    ...
    add_files("src/main.c", "src/bsp/bsp_delay.c", "src/bsp/bsp_system.c", "src/bsp/bsp_uid.c", "src/drv/*.c", "src/usb/bsp_usb.c", "src/wchlink/*.c", "src/wchlink/*.S", "sdk/Startup/startup_ch32x035_highcode.S")
