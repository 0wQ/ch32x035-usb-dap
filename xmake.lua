...
target("firmware")
    ...
    add_files("third_party/cherrydap/dap_main.c", "third_party/cherrydap/DAP/Source/DAP.c", "src/dap/SW_DP.c", "src/dap/SW_DP_SPI.c", "third_party/cherrydap/DAP/Source/DAP_vendor.c")
