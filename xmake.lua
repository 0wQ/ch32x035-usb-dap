...
target("firmware")
    ...
    add_files("src/main.c", "src/bsp/*.c", "src/drv/*.c", "src/status/*.c", "src/usb/bsp_usb.c", "src/dap/cherrydap_port.c", "sdk/Startup/startup_ch32x035_highcode.S")
    ...
    add_files("src/dap/dap_main.c", "third_party/cherrydap/DAP/Source/DAP.c", "src/dap/sw_dp.c", "third_party/cherrydap/DAP/Source/DAP_vendor.c")
